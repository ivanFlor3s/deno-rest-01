  ...
  */
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    S extends { select: any; include: any }
      ...
      : S extends { include: any } & (UserArgs | UserFindManyArgs) ? User
      : S extends { select: any } & (UserArgs | UserFindManyArgs) ? {
          [P in TruthyKeys<S["select"]>]: P extends keyof User ? User[P]
            : never;
        }
      : User;
  ...
  export type UserWhereInput = {
    ...
    googleAcount?: BoolFilter | boolean;
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    googleAcount?: BoolWithAggregatesFilter | boolean;
  ...
  export type UserUpdateInput = {
    ...
    googleAcount?: BoolFieldUpdateOperationsInput | boolean;
